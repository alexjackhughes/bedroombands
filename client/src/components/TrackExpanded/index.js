                      ...
                      <div className="highlight edit-track-form">
                        ...
                        <div className="row profile-entry">
                          ...
                          <div className="profile-data">
                            <input className="input-data" type="text" value={this.state.title} onChange={this.handleTitle} />
                          </div>
                        </div>
                        ...
                        <div className="row profile-entry">
                          ...
                          <div className="profile-data">
                            <input className="input-data" type="text" value={this.state.description} onChange={this.handleDescription} />
                          </div>
                        </div>
                        ...
                        <div className="row profile-entry">
                          ...
                          <div className="profile-data">
                            <input className="input-data" type="text" value={this.state.soundCloudUrl} onChange={this.handleSoundCloudUrl} />
                          </div>
                        </div>
                        ...
                        <div className="row profile-entry">
                          ...
                          <div className="profile-data">
                            <input className="input-data" type="text" value={this.state.type} onChange={this.handleType} />
                          </div>
                        </div>
